...
contract DonationCampaigns {
    ...
    */
    function createCampaign(
        ...
        require(_campaignClosedDate >= block.timestamp, "Campaign closed date must be present or in the future.");
    ...
    */
    function makeDonation(uint _index, uint donation) public payable {
        ...
        require(campaigns[_index].closed == false, "Campaign can no longer receive donation as it has been closed");
        require(
